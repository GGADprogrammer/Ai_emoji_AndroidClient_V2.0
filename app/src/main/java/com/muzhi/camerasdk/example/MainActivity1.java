...
//            }
//        });
        btnMyCloudAlbum=(Button)findViewById(R.id.btn_cloud);
        btnMyCloudAlbum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(ImageList.getImageList().isEmpty()){
                    Toast.makeText(MainActivity1.this, "您还未上传图片到云相册", Toast.LENGTH_SHORT).show();
                }else {
                    Intent intent = new Intent(MainActivity1.this, MyCloudAlbumActivity.class);
        ...
        btnSite=(Button)findViewById(R.id.btn_official_site2);
        btnSite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity1.this, SiteActivity.class);
                startActivity(intent);
            }
        });
